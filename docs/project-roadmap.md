...
- [x] Table Expand - Expandable tables with fullscreen, drag-to-resize/hide columns, and oversized-cell clamping (776 LOC across 5 files)
...
- [x] Chrome Web Store listing (`chrome-web-store-listing.md`)
- [x] Firefox Add-ons listing (`firefox-addon-listing.md`)

#### Quality Assurance

- [x] Cross-browser testing (Chrome 88+, Firefox 112+)
- [x] Security review (input validation, CSP compliance)
- [x] Biome linting + web-ext linting for Firefox

#### Packaging

- [x] Icon design (16/48/128px)
- [x] Promo images for Chrome Web Store
- [x] Screenshot capture for store listings
- [x] Privacy policy (`PRIVACY.md`)
- [x] Chrome Web Store listing
- [x] Firefox Add-ons listing

#### Release Preparation

- [x] Changelog (auto-generated by release-please)
- [x] Build production bundle (`pnpm build`)
- [x] Zip dist/ for Web Store upload
- [x] Test sideloaded production build

### Phase 3: Store Launches ✓ (Complete)

**Timeline:** Apr 12-13, 2026
**Status:** 100% Complete
...
### Phase 5: Enhancements & Community 📅 (Planned)
...
- [x] CI/CD pipeline (GitHub Actions)
  - [x] Lint on PR
  - [x] Test on PR
  - [x] Build on release tag
  - [x] Auto-release via release-please
